...
import SecuredAdminRoute from "./auth/SecuredAdminRoute";
    ...
    <Provider store={store}>
      <Router>
        ...
        <Switch>
          ...
          <SecuredRoute
            exact
            path="/job_seeker/createBackground/"
            role="JOB_SEEKER"
            component={Background}
          />
          <SecuredRoute
            exact
            path="/job_seeker/uploadcv/"
            role="JOB_SEEKER"
            component={UploadCV}
          />
          <Route exact path="/admin/" role="ADMIN" component={AdminSignIn} />
          <SecuredAdminRoute
            exact
